    ...
    <div className="min-h-screen bg-[#f5f0e8] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <p className="text-xs uppercase tracking-widest text-stone-400 mb-2">Join us today</p>
          <h1 className="font-['Playfair_Display'] text-5xl font-black text-[#1a1a1a]">Create Account</h1>
        ...
        <p className="text-sm mt-8 text-center text-stone-500">
          ...
          <Link href="/login" className="text-[#1a1a1a] underline underline-offset-4 hover:text-[#c0392b] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
